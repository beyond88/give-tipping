    ...
    <table class="form-table">
        <tbody>
            <tr valign="top">
                ...
                <td class="">
                    <select name="give_tipping_type" id="give_tipping_type" class="">
            ...
            <tr valign="top">
                ...
                <td class="">
                    <div class="give-tipping-control-wrapper">
                        <table class="form-table">
                            <tbody id="append_body" class="ui-sortable">
                                <tr valign="top" class="ui-sortable-handle">
                                    <td class="middle-align">
                                        <input type="number" min="1" step="1" name="give_tipping_amount[]" maxlength="80" class="gt-meta-field playfield" placeholder="10" value="">
                                        <a href="javascript:void(0);" class="up_button" title="Up field">
                                ...
                                <tr valign="top" class="ui-sortable-handle">
                                    <td class="middle-align">
                                        <input type="text" name="give_tipping_amount[]" maxlength="80" class="gt-meta-field playfield" placeholder="10" value="">
                                        <a href="javascript:void(0);" class="up_button" title="Up field">
                                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
                                                <style type="text/css">.st0{fill:#9BA1B0;}</style>
                                                <path class="st0" d="M99.1,47.9L82.7,32.5c-0.8-0.8-2.1-1-3.1-0.5c-1.1,0.5-1.7,1.5-1.7,2.6v6.7H58.7V22.1h6.7 c1.2,0,2.2-0.7,2.6-1.7c0.5-1.1,0.2-2.3-0.5-3.1L52.1,0.9C51.6,0.3,50.8,0,50,0s-1.6,0.3-2.1,0.9L32.5,17.3c-0.8,0.8-1,2.1-0.5,3.1 c0.5,1.1,1.5,1.7,2.6,1.7h6.7v19.2H22.1v-6.7c0-1.2-0.7-2.2-1.7-2.6c-1.1-0.5-2.3-0.2-3.1,0.5L0.9,47.9C0.3,48.4,0,49.2,0,50 s0.3,1.6,0.9,2.1l16.3,15.4c0.8,0.8,2.1,1,3.1,0.5c1.1-0.5,1.7-1.5,1.7-2.6v-6.7h19.2v19.2h-6.7c-1.2,0-2.2,0.7-2.6,1.7 c-0.5,1.1-0.2,2.3,0.5,3.1l15.4,16.3c0.5,0.6,1.3,0.9,2.1,0.9s1.6-0.3,2.1-0.9l15.4-16.3c0.8-0.8,1-2.1,0.5-3.1 c-0.5-1.1-1.5-1.7-2.6-1.7h-6.7V58.7h19.2v6.7c0,1.2,0.7,2.2,1.7,2.6c1.1,0.5,2.3,0.2,3.1-0.5l16.3-15.4c0.6-0.5,0.9-1.3,0.9-2.1 S99.7,48.4,99.1,47.9z"></path>
                            ...
                            <tbody>
                                <tr valign="top">
                                    ...
                                    <div class="gt-click-area-wrapper" >
                                        <div class="gt-click-overlay" id="gt-click-overlay"></div>
                                            <label for="add-field" class="gt-group-field-add">
                                                <span class="dashicons dashicons-plus-alt gt_add_field_icon"></span>
                                                <span class="gt_add_field_label">Add</span>
                                            <input type="button" name="add-field" id="add-field" class="add-field" value="">
                                        </label>
                                    </div>
                                    </td>
                                </tr>
